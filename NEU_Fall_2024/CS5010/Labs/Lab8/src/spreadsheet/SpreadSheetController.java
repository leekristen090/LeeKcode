...
public class SpreadSheetController {
  ...
  /**
   * Construct a spreadsheet controller.
  ...
  /**
   * Runs the interactive user input and output.
   * @throws IllegalStateException if illegal method invoked
   */
  public void goMethod() throws IllegalStateException {
    ...
    while (!quit) { //continue until the user quits
      ...
      switch (userInstruction) {
        ...
        case "print-value": //print a value from the cell
          ...
          break;
        case "bulk-assign": // new instruction for bulk assignment
          try {
            ...
            // Call the new method in BetterSpreadSheet
            sheet.setRegion(startRow, startCol - 1, endRow, endCol - 1, val);
          } catch (IllegalArgumentException e) {
            writeMessage("Error: " + e.getMessage() + System.lineSeparator());
          }
          break;
