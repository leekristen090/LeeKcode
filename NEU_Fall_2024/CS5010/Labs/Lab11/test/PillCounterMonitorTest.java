...
/**
 * This is the junit test class for the pill counter monitor.
 */
public class PillCounterMonitorTest {

  /**
   * Test that mimics the test given but using the monitor.
   */
  @Test
  public void usage() {
    PillAddMonitor counter = new PillAddMonitor(new LoggingPillCounter());
