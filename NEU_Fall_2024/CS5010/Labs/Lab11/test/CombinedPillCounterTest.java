...
/**
 * This is the junit test class for the combination of the batch adding decorator and the
 * add-monitoring decorator.
 */
public class CombinedPillCounterTest {

  /**
   * Test that mimics the given test but using the combo.
   */
  @Test
  public void usage() {
    CombinedPillCounter combo = new CombinedPillCounter(new LoggingPillCounter());
    boolean result = conveyerBelt(combo);
    assertTrue(result);
  }
