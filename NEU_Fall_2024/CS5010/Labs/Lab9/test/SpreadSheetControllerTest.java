...
/**
 * This is the junit test for the spreadsheet controller.
 */
public class SpreadSheetControllerTest {

  /**
   * This is a test for assigning values.
   */
  @Test
  public void testAssignValue() {
    ...
    expected.append("Welcome to the spreadsheet program!" + System.lineSeparator()
            ...
            + System.lineSeparator() + "menu (Print supported instruction list)"
            + System.lineSeparator() + "q or quit (quit the program) " + System.lineSeparator());
    for (int i = 1; i <= 3; i += 1) {
      for (int j = 0; j < 2; j += 1) {
