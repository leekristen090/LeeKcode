...
/**
 * This is the CommandFactory class. This helps apply image manipulations.
 */
public class CommandFactory extends ImageController {
  ...
  public static void applySepia(String[] params) throws IOException {
    ...
    Image originalImage = IMAGE_MAP.get(originalAlias);
  ...
  public static void flip(String[] params) throws IOException {
    ...
    else if (params[0].equals("vertical-flip")) {
  ...
  public static void applyCombine(String[] params) {
    ...
    Image redImage = IMAGE_MAP.get(redAlias);
    Image greenImage = IMAGE_MAP.get(greenAlias);
    Image blueImage = IMAGE_MAP.get(blueAlias);
    ...
    IMAGE_MAP.put(comboAlias, comboImage);
  ...
  public static void applySplit(String[] params) {
    ...
    IMAGE_MAP.put(redAlias, redImage);
    IMAGE_MAP.put(greenAlias, greenImage);
    IMAGE_MAP.put(blueAlias, blueImage);
  }
  ...
  public static void applyHistogram(String[] params) throws IOException {
    ...
    IMAGE_MAP.put(newAlias, histogramImage);
  }
  ...
  public static void applyCompression(String[] params) throws IOException {
    ...
    try {
      ...
      System.out.println("Error applying compression: " + e.getMessage());
